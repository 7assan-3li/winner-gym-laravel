                        ...
                        <div class="wg-action-body">
                            ...
                            <div x-show="subStep===2" x-cloak class="wg-sub-step-panel">
                                ...
                                <div class="wg-action-grid wg-action-grid--3">
                                    <label><span>الخصم</span><input type="number" min="0" step="0.01" wire:model.live.debounce.400ms="sub_discount_amount"></label>
                                ...
                                @if($sub_payment_plan === 'full')
                                    <div class="wg-action-grid wg-action-grid--2 wg-full-payment-row">
                                        <label><span>المبلغ الكامل <b>*</b></span><input type="number" min="0" step="0.01" wire:model="sub_first_payment_amount" readonly aria-readonly="true"><small>يُحتسب تلقائيًا من سعر الباقة بعد الخصم ولا يمكن تخفيضه.</small></label>
                    ...
                    <form wire:submit="receivePayment">
                        <div class="wg-action-body">
                            ...
                            @if($paymentSubscription && $paymentInstallment)
                                ...
                                <label><span>مبلغ الدفعة الحالية <b>*</b></span><div class="wg-input-with-unit"><input type="number" step="0.01" wire:model="payment_amount"><i>{{ $payment_currency }}</i></div></label>
                ...
                <section class="wg-action-modal wg-action-modal--xl" data-wg-modal="product" x-show="$wire.modal === 'product'" x-cloak dir="rtl">
                    ...
                    <form wire:submit="createProduct">
                        <div class="wg-action-body">
                            ...
                            <div class="wg-action-grid wg-action-grid--3"><label><span>سعر البيع <b>*</b></span><input type="number" step="0.01" min="0" wire:model="product_selling_price"></label><label><span>سعر التكلفة</span><input type="number" step="0.01" min="0" wire:model="product_purchase_cost"></label><label><span>الحد الأدنى للتنبيه</span><input type="number" min="0" wire:model="product_minimum_quantity"></label></div>
